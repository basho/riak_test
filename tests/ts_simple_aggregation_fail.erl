...
confirm() ->
    ...
    Expected1 = {error, {1001, <<"invalid_query: \nFunction 'SUM' called with arguments of the wrong type [boolean].">>}},
    ...
    Expected5 = {error, {1001, <<"invalid_query: \nFunction 'STDDEV_SAMP' called with arguments of the wrong type [boolean].">>}},
    ...
    Expected7 = {error, {1001, <<"invalid_query: \nFunction 'STDDEV_POP' called with arguments of the wrong type [timestamp].">>}},
    ...
    Expected8 = {error, {1001, <<"invalid_query: \nFunction 'AVG' called with arguments of the wrong type [boolean].">>}},
