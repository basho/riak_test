...
verify_capabilities() ->
    ...
    Nodes = rt:deploy_nodes(4, [current, "0.14.2", "1.1.2", "1.0.3"]),
    [Node1, Node2, Node3, Node4] = Nodes,

    lager:info("Verify vnode_routing == proxy"),
    ?assertEqual(proxy, capability(Node1, {riak_core, vnode_routing})),
    ...
    ?assertEqual(ok, wait_until_capability(Node1, {riak_core, vnode_routing}, legacy)),
